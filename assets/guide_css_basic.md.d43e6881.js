import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.24a71683.js";const A=JSON.parse('{"title":"基础","description":"","frontmatter":{"outline":"deep"},"headers":[{"level":2,"title":"BEM 规范","slug":"bem-规范","link":"#bem-规范","children":[]},{"level":2,"title":"BFC","slug":"bfc","link":"#bfc","children":[{"level":3,"title":"BFC 形成条件","slug":"bfc-形成条件","link":"#bfc-形成条件","children":[]},{"level":3,"title":"BFC 特性","slug":"bfc-特性","link":"#bfc-特性","children":[]}]},{"level":2,"title":"命名建议","slug":"命名建议","link":"#命名建议","children":[]},{"level":2,"title":"css 预处理器","slug":"css-预处理器","link":"#css-预处理器","children":[]},{"level":2,"title":"浏览器滚动条","slug":"浏览器滚动条","link":"#浏览器滚动条","children":[{"level":3,"title":"mixin.scss","slug":"mixin-scss","link":"#mixin-scss","children":[]},{"level":3,"title":"usage","slug":"usage","link":"#usage","children":[]}]},{"level":2,"title":"文字溢出显示省略号","slug":"文字溢出显示省略号","link":"#文字溢出显示省略号","children":[]},{"level":2,"title":"normalize.css","slug":"normalize-css","link":"#normalize-css","children":[]}],"relativePath":"guide/css/basic.md"}'),p={name:"guide/css/basic.md"},o=l(`<h1 id="基础" tabindex="-1">基础 <a class="header-anchor" href="#基础" aria-hidden="true">#</a></h1><h2 id="bem-规范" tabindex="-1">BEM 规范 <a class="header-anchor" href="#bem-规范" aria-hidden="true">#</a></h2><div class="language-html"><button title="Copy Code" class="copy"></button><span class="lang">html</span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#89DDFF;">&lt;</span><span style="color:#F07178;">div</span><span style="color:#89DDFF;"> </span><span style="color:#C792EA;">class</span><span style="color:#89DDFF;">=</span><span style="color:#89DDFF;">&quot;</span><span style="color:#C3E88D;">health-account</span><span style="color:#89DDFF;">&quot;</span><span style="color:#89DDFF;">&gt;</span></span>
...
<span class="line"></span></code></pre></div><h2 id="bfc" tabindex="-1">BFC <a class="header-anchor" href="#bfc" aria-hidden="true">#</a></h2><p>BFC（Block Formatting Context）块级格式化上下文，是 Web 页面中盒模型布局的 CSS 渲染模式，指一个独立的渲染区域或者说是一个隔离的独立容器。</p><h3 id="bfc-形成条件" tabindex="-1">BFC 形成条件 <a class="header-anchor" href="#bfc-形成条件" aria-hidden="true">#</a></h3><ol><li>浮动元素，float 除 none 以外的值</li><li>定位元素，position（absolute，fixed）</li><li>display 为以下其中之一的值 inline-block，table-cell，table-caption</li><li>overflow 除了 visible 以外的值（hidden，auto，scroll）</li></ol><h3 id="bfc-特性" tabindex="-1">BFC 特性 <a class="header-anchor" href="#bfc-特性" aria-hidden="true">#</a></h3><ol><li>内部的 Box 会在垂直方向上一个接一个的放置</li><li>垂直方向上的距离由 margin 决定；（解决外边距重叠问题）</li><li>bfc 的区域不会与 float 的元素区域重叠（防止浮动文字环绕）</li><li>计算 bfc 的高度时，浮动元素也参与计算（清除浮动）</li><li>bfc 就是页面上的一个独立容器，容器里面的子元素不会影响外面元素</li></ol><h2 id="命名建议" tabindex="-1">命名建议 <a class="header-anchor" href="#命名建议" aria-hidden="true">#</a></h2><ol><li>- 中划线：仅作为连字符，表示某个块或者某个子元素的多单词之间的连接记号，如 <code>health-account</code>。</li><li>__ 双下划线：用来连接块和块的子元素</li><li>-- 双中划线：用来描述一个块或者块的子元素的一种状态</li><li>合理的属性书写顺序</li><li>建议按照布局定位、自身属性、文本属性、其他属性的顺序来书写，而不是想到什么写什么</li><li>不要滥用 <code>id</code> 选择器和 <code>!important</code></li><li><code>Vue</code> 中建议使用 <code>scoped</code></li></ol><h2 id="css-预处理器" tabindex="-1">css 预处理器 <a class="header-anchor" href="#css-预处理器" aria-hidden="true">#</a></h2><p><code>less</code> <code>sass</code> <code>scss</code> <code>stylus</code></p><h2 id="浏览器滚动条" tabindex="-1">浏览器滚动条 <a class="header-anchor" href="#浏览器滚动条" aria-hidden="true">#</a></h2><h3 id="mixin-scss" tabindex="-1">mixin.scss <a class="header-anchor" href="#mixin-scss" aria-hidden="true">#</a></h3><div class="language-scss"><button title="Copy Code" class="copy"></button><span class="lang">scss</span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#676E95;font-style:italic;">// 通用滚动条</span></span>
...
<span class="line"><span style="color:#A6ACCD;">  </span><span style="color:#89DDFF;">}</span></span>
<span class="line"><span style="color:#89DDFF;">}</span></span>
<span class="line"></span></code></pre></div><h3 id="usage" tabindex="-1">usage <a class="header-anchor" href="#usage" aria-hidden="true">#</a></h3><div class="language-scss"><button title="Copy Code" class="copy"></button><span class="lang">scss</span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#89DDFF;font-style:italic;">@import</span><span style="color:#A6ACCD;"> </span><span style="color:#89DDFF;">&#39;</span><span style="color:#C3E88D;">～assets/style/mixin.scss</span><span style="color:#89DDFF;">&#39;</span><span style="color:#89DDFF;">;</span></span>
<span class="line"></span>
...
<span class="line"><span style="color:#89DDFF;">}</span></span>
<span class="line"></span></code></pre></div><h2 id="文字溢出显示省略号" tabindex="-1">文字溢出显示省略号 <a class="header-anchor" href="#文字溢出显示省略号" aria-hidden="true">#</a></h2><div class="language-css"><button title="Copy Code" class="copy"></button><span class="lang">css</span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#89DDFF;">.</span><span style="color:#FFCB6B;">text-ellipsis</span><span style="color:#A6ACCD;"> </span><span style="color:#89DDFF;">{</span></span>
...
<span class="line"><span style="color:#89DDFF;">}</span></span>
<span class="line"></span></code></pre></div><h2 id="normalize-css" tabindex="-1"><a href="https://necolas.github.io/normalize.css/8.0.1/normalize.css" target="_blank" rel="noreferrer">normalize.css</a> <a class="header-anchor" href="#normalize-css" aria-hidden="true">#</a></h2><details class="details custom-block"><summary>normalize.css</summary><div class="language-css"><button title="Copy Code" class="copy"></button><span class="lang">css</span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#676E95;font-style:italic;">/*! normalize.css v8.0.1 | MIT License | github.com/necolas/normalize.css */</span></span>
<span class="line"></span>
...
<span class="line"><span style="color:#A6ACCD;">  </span><span style="color:#B2CCD6;">display</span><span style="color:#89DDFF;">:</span><span style="color:#A6ACCD;"> none</span><span style="color:#89DDFF;">;</span></span>
<span class="line"><span style="color:#89DDFF;">}</span></span>
<span class="line"></span></code></pre></div></details>`,22),e=[o];function t(c,r,y,i,D,F){return n(),a("div",null,e)}const d=s(p,[["render",t]]);export{A as __pageData,d as default};
