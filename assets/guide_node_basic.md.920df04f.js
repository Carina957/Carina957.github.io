import{_ as s,c as a,o as n,Q as l}from"./chunks/framework.9ebe056a.js";const p="/assets/npm-list.b733f29e.png",e="/assets/npm-list-info.13a78447.png",u=JSON.parse('{"title":"Node","description":"","frontmatter":{"outline":"deep"},"headers":[],"relativePath":"guide/node/basic.md"}'),o={name:"guide/node/basic.md"},t=l(`<h1 id="node" tabindex="-1">Node <a class="header-anchor" href="#node" aria-hidden="true">#</a></h1><h2 id="volta" tabindex="-1">volta <a class="header-anchor" href="#volta" aria-hidden="true">#</a></h2><div class="vp-code-group"><div class="tabs"><input type="radio" name="group-eTQ_h" id="tab-kDXOhrM" checked="checked"><label for="tab-kDXOhrM">curl</label><input type="radio" name="group-eTQ_h" id="tab-ZgwnCwa"><label for="tab-ZgwnCwa">brew</label></div><div class="blocks"><div class="language-sh active"><button title="Copy Code" class="copy"></button><span class="lang">sh</span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#FFCB6B;">$</span><span style="color:#A6ACCD;"> </span><span style="color:#C3E88D;">curl</span><span style="color:#A6ACCD;"> </span><span style="color:#C3E88D;">https://get.volta.sh</span><span style="color:#A6ACCD;"> </span><span style="color:#89DDFF;">|</span><span style="color:#A6ACCD;"> </span><span style="color:#FFCB6B;">bash</span></span>
...
<span class="line"></span></code></pre></div><p><img src="`+p+'" alt="npm-list"></p><p><img src="'+e+'" alt="npm-list-info"></p>',13),c=[t];function r(i,C,y,d,A,D){return n(),a("div",null,c)}const m=s(o,[["render",r]]);export{u as __pageData,m as default};
