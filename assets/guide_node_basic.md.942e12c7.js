import{_ as s,c as a,o as n,a as l}from"./app.1559a474.js";const p="/assets/npm-list.b733f29e.png",e="/assets/npm-list-info.13a78447.png",u=JSON.parse('{"title":"Node","description":"","frontmatter":{"outline":"deep"},"headers":[],"relativePath":"guide/node/basic.md"}'),o={name:"guide/node/basic.md"},t=l(`<h1 id="node" tabindex="-1">Node <a class="header-anchor" href="#node" aria-hidden="true">#</a></h1><h2 id="volta" tabindex="-1">volta <a class="header-anchor" href="#volta" aria-hidden="true">#</a></h2><div class="vp-code-group"><div class="tabs"><input type="radio" name="group-esCkL" id="tab-sD-W8UK" checked="checked"><label for="tab-sD-W8UK">curl</label><input type="radio" name="group-esCkL" id="tab-Xj-_UdF"><label for="tab-Xj-_UdF">brew</label></div><div class="blocks"><div class="language-sh active"><button title="Copy Code" class="copy"></button><span class="lang">sh</span><pre class="shiki material-palenight"><code><span class="line"><span style="color:#FFCB6B;">curl</span><span style="color:#A6ACCD;"> </span><span style="color:#C3E88D;">https://get.volta.sh</span><span style="color:#A6ACCD;"> </span><span style="color:#89DDFF;">|</span><span style="color:#A6ACCD;"> </span><span style="color:#FFCB6B;">bash</span></span>
<span class="line"></span></code></pre></div><div class="language-sh"><button title="Copy Code" class="copy"></button><span class="lang">sh</span><pre class="shiki material-palenight"><code><span class="line"><span style="color:#FFCB6B;">brew</span><span style="color:#A6ACCD;"> </span><span style="color:#C3E88D;">install</span><span style="color:#A6ACCD;"> </span><span style="color:#C3E88D;">volta</span></span>
...
<span class="line"></span></code></pre></div><p>之后，你就可以正常使用 <code>volta</code></p><div class="language-text"><button title="Copy Code" class="copy"></button><span class="lang">text</span><pre class="shiki material-palenight"><code><span class="line"><span style="color:#A6ACCD;">Volta 1.1.1</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h2 id="npm" tabindex="-1">npm <a class="header-anchor" href="#npm" aria-hidden="true">#</a></h2><div class="language-sh"><button title="Copy Code" class="copy"></button><span class="lang">sh</span><pre class="shiki material-palenight"><code><span class="line"><span style="color:#676E95;font-style:italic;"># 查看全局安装的模块</span></span>
...
<span class="line"></span></code></pre></div><p><img src="`+p+'" alt="npm-list"></p><p><img src="'+e+'" alt="npm-list-info"></p>',11),c=[t];function r(i,C,y,A,d,D){return n(),a("div",null,c)}const m=s(o,[["render",r]]);export{u as __pageData,m as default};
